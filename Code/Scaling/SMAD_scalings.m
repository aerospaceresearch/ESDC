...
function [systemmasses systempowers] = SMAD_scalings(data)
   ...
   systemmasses.m_dry_nomargin  = determine_m_dry(data);          %% HERE BUG
   ...
   systemmasses.m_structure     = scale_SMAD_parameter(systemmasses.m_dry_margin, sc_type, "m_total", "fraction_m_structmech")*systemmasses.m_dry_margin;
   ...
   systemmasses.m_misc          = scale_SMAD_parameter(systemmasses.m_dry_margin, sc_type, "m_total", "fraction_m_other")*systemmasses.m_dry_margin;
...
%   
   ...
   systempowers.p_payload       = scale_SMAD_parameter(systempowers.p_total, sc_type, "power_total", "fraction_p_payload")*systempowers.p_total;
   systempowers.p_structure     = scale_SMAD_parameter(systempowers.p_total, sc_type, "power_total", "fraction_p_structmech")*systempowers.p_total;
   systempowers.p_thermal       = scale_SMAD_parameter(systempowers.p_total, sc_type, "power_total", "fraction_p_thermal")*systempowers.p_total;
   systempowers.p_power         = scale_SMAD_parameter(systempowers.p_total, sc_type, "power_total", "fraction_p_power")*systempowers.p_total;  
   systempowers.p_ttc           = scale_SMAD_parameter(systempowers.p_total, sc_type, "power_total", "fraction_p_TTC")*systempowers.p_total;
   systempowers.p_adc           = scale_SMAD_parameter(systempowers.p_total, sc_type, "power_total", "fraction_p_ADC")*systempowers.p_total;
   systempowers.p_propulsion    = scale_SMAD_parameter(systempowers.p_total, sc_type, "power_total", "fraction_p_propulsion")*systempowers.p_total;
