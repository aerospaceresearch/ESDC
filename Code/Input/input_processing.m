function [mission_parameters database  simulation_parameters]= input_processing()
 %InputReading
    ...
    for i= 1:size(input_cases,2)
      mission_parameters.Satellite_parameters.input_case{i}(1,1).derived = system_completion_estimation(mission_parameters.Satellite_parameters.input_case{i}(1,1)); %todo 1 -> i 
    end
...
% spacecraft type derivation 
  ...
  derived_parameters = {known, unknown};
endfunction
